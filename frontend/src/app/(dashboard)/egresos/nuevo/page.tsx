 ...
 * Requirements: 2.1, 2.5, 4.1, 4.2, 5.1, 5.2, 7.5
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'El comprobante de egreso se creó exitosamente',
      });
  ...
  return (
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Nuevo Egreso</h2>
          <p className="text-muted-foreground">
            Registra un nuevo comprobante de egreso
          </p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Tipo de Comprobante - Subtask 13.1 */}
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
              <div className="space-y-2">
                <Label htmlFor="fecAbono">Fecha del Abono</Label>
                <Input
                  id="fecAbono"
                  type="date"
              ...
              <div className="space-y-2">
                <Label htmlFor="desAbono">Medio de Pago</Label>
                <Input
                  id="desAbono"
