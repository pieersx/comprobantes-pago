...
BEGIN
    ...
    -- Tablas del sistema de comprobantes de pago (egresos e ingresos)
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE VTACOMP_PAGODET CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE VTACOMP_PAGOCAB CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE COMP_PAGODET CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE COMP_PAGOEMPLEADO_DET CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE DPROY_PARTIDA_MEZCLA CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE PROY_PARTIDA_MEZCLA CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE PROY_PARTIDA CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE PARTIDA_MEZCLA CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP TABLE PARTIDA CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;

    -- Tablas originales del profesor
    ...
    -- Secuencias del sistema de comprobantes
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_PARTIDA_E'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_PARTIDA_I'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_CODPARTIDAS'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_PARTIDA_MEZCLA_E'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_PARTIDA_MEZCLA_I'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_PROY_PARTIDA_MEZCLA_E'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_PROY_PARTIDA_MEZCLA_I'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_DPROY_PARTIDA_MEZCLA_E'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_DPROY_PARTIDA_MEZCLA_I'; EXCEPTION WHEN OTHERS THEN NULL; END;
    BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE SEC_NRO_PAGO_VTA'; EXCEPTION WHEN OTHERS THEN NULL; END;
    ...
    BEGIN EXECUTE IMMEDIATE 'DROP PROCEDURE INSERTAR_COMPROBANTE_VENTA'; EXCEPTION WHEN OTHERS THEN NULL; END;
...
-- ==================================================================
-- TABLAS ADICIONALES PARA SISTEMA DE COMPROBANTES DE PAGO
...
CREATE TABLE PARTIDA (
    ...
    CONSTRAINT PARTIDA_CIA_FK FOREIGN KEY (CodCia) REFERENCES CIA (CodCIA),
    CONSTRAINT PARTIDA_UNIMED_FK FOREIGN KEY (TUniMed, EUniMed) REFERENCES ELEMENTOS (CodTab, CodElem)
);

-- ==================================================================
-- PARTIDA_MEZCLA: Composición de partidas
-- Define qué subpartidas conforman una partida principal
-- ==================================================================
CREATE TABLE PARTIDA_MEZCLA (
    ...
    CONSTRAINT PARTIDA_MEZCLA_PARTIDA_FK FOREIGN KEY (CodCia, IngEgr, CodPartida) REFERENCES PARTIDA (CodCia, IngEgr, CodPartida),
    CONSTRAINT PARTIDA_MEZCLA_ELEM_FK FOREIGN KEY (TUniMed, EUniMed) REFERENCES ELEMENTOS (CodTab, CodElem)
);
...
CREATE TABLE PROY_PARTIDA (
    ...
    CONSTRAINT PROY_PARTIDA_PROYECTO_FK FOREIGN KEY (CodCia, CodPyto) REFERENCES PROYECTO (CodCIA, CodPyto),
    CONSTRAINT PROY_PARTIDA_PARTIDA_FK FOREIGN KEY (CodCia, IngEgr, CodPartida) REFERENCES PARTIDA (CodCia, IngEgr, CodPartida)
);

-- ==================================================================
-- PROY_PARTIDA_MEZCLA: Mezcla de partidas por proyecto
-- ==================================================================
CREATE TABLE PROY_PARTIDA_MEZCLA (
    ...
    CONSTRAINT PROY_PARTIDA_MEZCLA_PP_FK FOREIGN KEY (CodCia, CodPyto, NroVersion, IngEgr, CodPartida) REFERENCES PROY_PARTIDA (CodCia, CodPyto, NroVersion, IngEgr, CodPartida),
    CONSTRAINT PROY_PARTIDA_MEZCLA_ELEM_FK FOREIGN KEY (TUniMed, EUniMed) REFERENCES ELEMENTOS (CodTab, CodElem)
);

-- ==================================================================
-- DPROY_PARTIDA_MEZCLA: Detalle de partida mezcla por proyecto
-- ==================================================================
CREATE TABLE DPROY_PARTIDA_MEZCLA (
    ...
    CONSTRAINT DPROY_PARTIDA_MEZCLA_PPM_FK FOREIGN KEY (CodCia, CodPyto, NroVersion, IngEgr, CodPartida, Corr) REFERENCES PROY_PARTIDA_MEZCLA (CodCia, CodPyto, NroVersion, IngEgr, CodPartida, Corr),
    CONSTRAINT DPROY_PARTIDA_MEZCLA_DESEMB_FK FOREIGN KEY (TDesembolso, EDesembolso) REFERENCES ELEMENTOS (CodTab, CodElem),
    CONSTRAINT DPROY_PARTIDA_MEZCLA_COMP_FK FOREIGN KEY (TCompPago, ECompPago) REFERENCES ELEMENTOS (CodTab, CodElem)
);
...
CREATE TABLE COMP_PAGODET (
    ...
    CONSTRAINT COMP_PAGODET_CAB_FK FOREIGN KEY (CodCIA, CodProveedor, NroCP) REFERENCES COMP_PAGOCAB (CodCIA, CodProveedor, NroCP),
    CONSTRAINT COMP_PAGODET_PARTIDA_FK FOREIGN KEY (CodCIA, IngEgr, CodPartida) REFERENCES PARTIDA (CodCia, IngEgr, CodPartida)
);
...
CREATE TABLE VTACOMP_PAGOCAB (
    ...
    CONSTRAINT VTACOMP_PAGOCAB_CLIENTE_FK FOREIGN KEY (CodCIA, CodCliente) REFERENCES CLIENTE (CodCIA, CodCliente),
    CONSTRAINT VTACOMP_PAGOCAB_PROYECTO_FK FOREIGN KEY (CodCIA, CodPyto) REFERENCES PROYECTO (CodCIA, CodPyto),
    CONSTRAINT VTACOMP_PAGOCAB_MONEDA_FK FOREIGN KEY (TMoneda, EMoneda) REFERENCES ELEMENTOS (CodTab, CodElem),
    CONSTRAINT VTACOMP_PAGOCAB_COMP_FK FOREIGN KEY (TCompPago, ECompPago) REFERENCES ELEMENTOS (CodTab, CodElem)
);
...
CREATE TABLE VTACOMP_PAGODET (
    ...
    CONSTRAINT VTACOMP_PAGODET_CAB_FK FOREIGN KEY (CodCIA, NroCP) REFERENCES VTACOMP_PAGOCAB (CodCIA, NroCP),
    CONSTRAINT VTACOMP_PAGODET_PARTIDA_FK FOREIGN KEY (CodCIA, IngEgr, CodPartida) REFERENCES PARTIDA (CodCia, IngEgr, CodPartida)
);
...
-- ==================================================================
-- SECUENCIAS ADICIONALES PARA SISTEMA DE COMPROBANTES
-- ==================================================================
...
BEGIN
    ...
    VALUES (
        ...
        IGV, COSTOT, -999, '-', '-', '-', TO_DATE('01-01-2022', 'DD-MM-YYYY'), 'RUTA_DOC', ANNOIN, ANNOFI, 0, LOGO,
        '-1', '1', OBS, VIGENT
    );
END;
/
...
-- Procedimiento para insertar COMPROBANTE DE VENTA A CLIENTES (INGRESOS)
CREATE OR REPLACE PROCEDURE INSERTAR_COMPROBANTE_VENTA(
    CIA IN VTACOMP_PAGOCAB.CodCIA%TYPE,
    NUM_COMP IN VTACOMP_PAGOCAB.NroCP%TYPE,
    PYTO IN VTACOMP_PAGOCAB.CodPyto%TYPE,
    CLI IN VTACOMP_PAGOCAB.CodCliente%TYPE,
    ...
    CAMBIO IN VTACOMP_PAGOCAB.TipCambio%TYPE,
    ...
    FECHABONO IN VTACOMP_PAGOCAB.FecAbono%TYPE,
    ...
    ESTADO IN VTACOMP_PAGOCAB.CodEstado%TYPE
) IS
BEGIN
    INSERT INTO VTACOMP_PAGOCAB (
        CodCIA, NroCP, CodPyto, CodCliente, NroPago, TCompPago, ECompPago, FecCP,
        TMoneda, EMoneda, TipCambio, ImpMO, ImpNetoMN, ImpIGVMN, ImpTotalMN,
        FotoCP, FotoAbono, FecAbono, DesAbono, Semilla, TabEstado, CodEstado
    )
    VALUES (
        CIA, NUM_COMP, PYTO, CLI, NROPAGO, TCOMPPAGO, ECOMPPAGO, FECHA,
        TMONEDA, EMONEDA, CAMBIO, IMPMO, IMPNETOMN, IMPIGVMN, IMPTOTALMN,
        FOTOCP, FOTOABONO, FECHABONO, DESABONO, SEMILLA, TABESTADO, ESTADO
    );
END;
...
-- Tabs y Elementos adicionales para sistema de comprobantes
INSERT INTO TABS VALUES ('012', 'Unidades de Medida', 'UNIMED', '1');
INSERT INTO TABS VALUES ('013', 'Desembolsos', 'DESEMB', '1');

INSERT INTO ELEMENTOS VALUES ('012', 'UND', 'UNIDADES', 'UND', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'GLB', 'GLOBAL', 'GLB', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'MTS', 'METROS', 'MTS', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'M2', 'METROS CUADRADOS', 'M2', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'M3', 'METROS CUBICOS', 'M3', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'KG', 'KILOGRAMOS', 'KG', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'TN', 'TONELADAS', 'TN', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'HH', 'HORAS HOMBRE', 'HH', '1');
INSERT INTO ELEMENTOS VALUES ('012', 'HM', 'HORAS MAQUINA', 'HM', '1');

INSERT INTO ELEMENTOS VALUES ('013', 'NOR', 'NORMAL', 'NOR', '1');
INSERT INTO ELEMENTOS VALUES ('013', 'ESP', 'ESPECIAL', 'ESP', '1');
...
-- Índices para tablas del sistema de comprobantes
CREATE INDEX idx_partida_codigo ON PARTIDA(CodPartidas);
CREATE INDEX idx_partida_descripcion ON PARTIDA(DesPartida);
CREATE INDEX idx_partida_vigente ON PARTIDA(Vigente);
CREATE INDEX idx_partida_ingegr ON PARTIDA(IngEgr);

CREATE INDEX idx_vtacomp_fecha ON VTACOMP_PAGOCAB(FecCP);
CREATE INDEX idx_vtacomp_estado ON VTACOMP_PAGOCAB(CodEstado);
CREATE INDEX idx_vtacomp_cliente ON VTACOMP_PAGOCAB(CodCliente);
CREATE INDEX idx_vtacomp_proyecto ON VTACOMP_PAGOCAB(CodPyto);

CREATE INDEX idx_comp_pagodet_partida ON COMP_PAGODET(CodPartida);
CREATE INDEX idx_vtacomp_pagodet_partida ON VTACOMP_PAGODET(CodPartida);
CREATE INDEX idx_comp_pagoempdet_partida ON COMP_PAGOEMPLEADO_DET(CodPartida);
...
-- Comentarios para tablas del sistema de comprobantes
COMMENT ON TABLE PARTIDA IS 'Catálogo de partidas presupuestales del sistema (ingresos y egresos)';
COMMENT ON TABLE PARTIDA_MEZCLA IS 'Composición de partidas presupuestales';
COMMENT ON TABLE PROY_PARTIDA IS 'Partidas asignadas por proyecto';
COMMENT ON TABLE PROY_PARTIDA_MEZCLA IS 'Mezcla de partidas por proyecto';
COMMENT ON TABLE DPROY_PARTIDA_MEZCLA IS 'Detalle de la mezcla de partidas por proyecto';
COMMENT ON TABLE COMP_PAGODET IS 'Detalle de comprobantes de pago a proveedores';
COMMENT ON TABLE COMP_PAGOEMPLEADO_DET IS 'Detalle de comprobantes de pago a empleados';
COMMENT ON TABLE VTACOMP_PAGOCAB IS 'Comprobantes de venta/ingresos a clientes - cabecera';
COMMENT ON TABLE VTACOMP_PAGODET IS 'Detalle de comprobantes de venta/ingresos';
...
WHERE table_name IN (
    ...
    'PARTIDA', 'PARTIDA_MEZCLA', 'PROY_PARTIDA', 'PROY_PARTIDA_MEZCLA',
    'DPROY_PARTIDA_MEZCLA', 'COMP_PAGODET', 'COMP_PAGOEMPLEADO_DET',
...
-- ==================================================================
-- VERIFICACIÓN DE TABLAS ADICIONALES (SISTEMA DE COMPROBANTES)
-- ==================================================================

SELECT 'TABLAS SISTEMA DE COMPROBANTES' as MENSAJE,
