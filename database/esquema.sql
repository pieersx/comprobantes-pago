...
BEGIN
    ...
    VALUES (
        ...
        IGV, COSTOT, -999, '-', '-', '-', TO_DATE('2022-01-01', 'YYYY-MM-DD'), 'RUTA_DOC', ANNOIN, ANNOFI, 0, LOGO,
        '-1', '1', OBS, VIGENT
    );
END;
/
...
-- ==================================================================
-- TABLAS ADICIONALES DEL ESQUEMA DEL PROFESOR
...
-- ==================================================================
-- VTACOMP_PAGOCAB: Comprobantes de venta a clientes (cabecera)
-- ==================================================================
...
-- ==================================================================
-- VTACOMP_PAGODET: Detalle de comprobantes de venta
-- ==================================================================
...
-- ==================================================================
-- SECUENCIAS ADICIONALES PARA LAS NUEVAS TABLAS
-- ==================================================================
...
COMMENT ON TABLE VTACOMP_PAGOCAB IS 'Comprobantes de venta a clientes - información de cabecera';
COMMENT ON TABLE VTACOMP_PAGODET IS 'Detalle de comprobantes de venta';

-- ==================================================================
-- PROCEDIMIENTO PARA INSERTAR COMPROBANTE DE VENTA
-- ==================================================================
...
-- ==================================================================
-- TABS Y ELEMENTOS ADICIONALES PARA PARTIDAS
-- ==================================================================
...
-- ==================================================================
-- VERIFICACIÓN DE TABLAS ADICIONALES
-- ==================================================================

SELECT 'TABLAS ADICIONALES CREADAS' as MENSAJE,
       COUNT(*) as TOTAL_TABLAS_NUEVAS
FROM user_tables
WHERE table_name IN (
    'PARTIDA', 'PARTIDA_MEZCLA', 'PROY_PARTIDA', 'PROY_PARTIDA_MEZCLA',
    'DPROY_PARTIDA_MEZCLA', 'COMP_PAGODET', 'VTACOMP_PAGOCAB', 'VTACOMP_PAGODET'
);
