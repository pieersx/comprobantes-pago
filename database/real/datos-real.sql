-- ==================================================================
-- CONFIGURACIÓN DE SESIÓN - Para formato de fechas
-- ==================================================================
...
-- ==================================================================
-- 19. INSERTAR PARTIDAS - ESTRUCTURA JERÁRQUICA (INGRESOS Y EGRESOS)
-- ==================================================================
-- Columnas: CodCia, IngEgr, CodPartida, CodPartidas, DesPartida, FlgCC, Nivel, TUniMed, EUniMed, Semilla, Vigente
...
INSERT INTO PARTIDA VALUES (1, 'I', 1000, 'ING-000', 'INGRESOS REALES', 'N', 1, '012', 'UND', 1000, 1);

-- NIVEL 2: INGRESOS POR VENTA DE SERVICIOS (Subcategoría - NO usar en comprobantes)
INSERT INTO PARTIDA VALUES (1, 'I', 1100, 'ING-100', 'INGRESOS POR VENTA DE SERVICIOS', 'N', 2, '012', 'UND', 1100, 1);

-- NIVEL 3: Detalles de INGRESOS POR VENTA (USAR EN COMPROBANTES)
INSERT INTO PARTIDA VALUES (1, 'I', 1101, 'ING-101', 'CONSTRUCCION DE OBRAS CIVILES', 'N', 3, '012', 'UND', 1101, 1);
INSERT INTO PARTIDA VALUES (1, 'I', 1102, 'ING-102', 'SERVICIOS DE INGENIERIA', 'N', 3, '012', 'UND', 1102, 1);
INSERT INTO PARTIDA VALUES (1, 'I', 1103, 'ING-103', 'CONSULTORIA TECNICA', 'N', 3, '012', 'UND', 1103, 1);

-- NIVEL 2: INGRESOS POR CONTRATOS (Subcategoría - NO usar en comprobantes)
INSERT INTO PARTIDA VALUES (1, 'I', 1200, 'ING-200', 'INGRESOS POR CONTRATOS', 'N', 2, '012', 'UND', 1200, 1);

-- NIVEL 3: Detalles de INGRESOS POR CONTRATOS (USAR EN COMPROBANTES)
INSERT INTO PARTIDA VALUES (1, 'I', 1201, 'ING-201', 'CONTRATOS PUBLICOS', 'N', 3, '012', 'UND', 1201, 1);
INSERT INTO PARTIDA VALUES (1, 'I', 1202, 'ING-202', 'CONTRATOS PRIVADOS', 'N', 3, '012', 'UND', 1202, 1);

-- NIVEL 2: OTROS INGRESOS (Subcategoría - NO usar en comprobantes)
INSERT INTO PARTIDA VALUES (1, 'I', 1300, 'ING-300', 'OTROS INGRESOS', 'N', 2, '012', 'UND', 1300, 1);

-- NIVEL 3: Detalles de OTROS INGRESOS (USAR EN COMPROBANTES)
INSERT INTO PARTIDA VALUES (1, 'I', 1301, 'ING-301', 'INTERESES GANADOS', 'N', 3, '012', 'UND', 1301, 1);
INSERT INTO PARTIDA VALUES (1, 'I', 1302, 'ING-302', 'ALQUILER DE EQUIPOS', 'N', 3, '012', 'UND', 1302, 1);
...
INSERT INTO PARTIDA VALUES (1, 'E', 2000, 'EGR-000', 'EGRESOS REALES', 'N', 1, '012', 'UND', 2000, 1);

-- NIVEL 2: COSTOS DIRECTOS DE OBRA (Subcategoría - NO usar en comprobantes)
INSERT INTO PARTIDA VALUES (1, 'E', 2100, 'EGR-100', 'COSTOS DIRECTOS DE OBRA', 'N', 2, '012', 'UND', 2100, 1);

-- NIVEL 3: Detalles de COSTOS DIRECTOS (USAR EN COMPROBANTES)
INSERT INTO PARTIDA VALUES (1, 'E', 2101, 'EGR-101', 'MATERIALES DE CONSTRUCCION', 'N', 3, '012', 'UND', 2101, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2102, 'EGR-102', 'MANO DE OBRA DIRECTA', 'N', 3, '012', 'UND', 2102, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2103, 'EGR-103', 'EQUIPOS Y MAQUINARIA', 'N', 3, '012', 'UND', 2103, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2104, 'EGR-104', 'HONORARIOS PROFESIONALES', 'N', 3, '012', 'UND', 2104, 1);

-- NIVEL 2: GASTOS ADMINISTRATIVOS (Subcategoría - NO usar en comprobantes)
INSERT INTO PARTIDA VALUES (1, 'E', 2200, 'EGR-200', 'GASTOS ADMINISTRATIVOS', 'N', 2, '012', 'UND', 2200, 1);

-- NIVEL 3: Detalles de GASTOS ADMINISTRATIVOS (USAR EN COMPROBANTES)
INSERT INTO PARTIDA VALUES (1, 'E', 2201, 'EGR-201', 'SUELDOS ADMINISTRATIVOS', 'N', 3, '012', 'UND', 2201, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2202, 'EGR-202', 'SERVICIOS PROFESIONALES', 'N', 3, '012', 'UND', 2202, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2203, 'EGR-203', 'ALQUILER DE OFICINA', 'N', 3, '012', 'UND', 2203, 1);

-- NIVEL 2: SERVICIOS TECNICOS (Subcategoría - NO usar en comprobantes)
INSERT INTO PARTIDA VALUES (1, 'E', 2300, 'EGR-300', 'SERVICIOS TECNICOS', 'N', 2, '012', 'UND', 2300, 1);

-- NIVEL 3: Detalles de SERVICIOS TECNICOS (USAR EN COMPROBANTES)
INSERT INTO PARTIDA VALUES (1, 'E', 2301, 'EGR-301', 'INGENIERIA ESTRUCTURAL', 'N', 3, '012', 'UND', 2301, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2302, 'EGR-302', 'INGENIERIA CIVIL', 'N', 3, '012', 'UND', 2302, 1);
INSERT INTO PARTIDA VALUES (1, 'E', 2303, 'EGR-303', 'SUPERVISION DE OBRA', 'N', 3, '012', 'UND', 2303, 1);

COMMIT;

-- ==================================================================
-- 20. INSERTAR PROY_PARTIDA - ASIGNAR PARTIDAS A PROYECTOS
-- ==================================================================
-- Solo se asignan partidas de NIVEL 3 (último nivel) a los proyectos
-- Columnas: CodCia, CodPyto, Corr, IngEgr, CodPartida, CodPartidas, FlgCC, Nivel, TUniMed, EUniMed, EsUltNivel, Vigente

-- Proyecto 1 (Puente Lima-Callao) - INGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 1, 1, 'I', 1101, 'ING-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 1, 2, 'I', 1102, 'ING-102', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 1, 3, 'I', 1201, 'ING-201', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 1 (Puente Lima-Callao) - EGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 1, 4, 'E', 2101, 'EGR-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 1, 5, 'E', 2102, 'EGR-102', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 1, 6, 'E', 2103, 'EGR-103', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 1, 7, 'E', 2104, 'EGR-104', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 1, 8, 'E', 2301, 'EGR-301', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 2 (Carretera Panamericana) - INGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 2, 1, 'I', 1101, 'ING-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 2, 2, 'I', 1201, 'ING-201', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 2 (Carretera Panamericana) - EGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 2, 3, 'E', 2101, 'EGR-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 2, 4, 'E', 2102, 'EGR-102', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 2, 5, 'E', 2302, 'EGR-302', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 2, 6, 'E', 2303, 'EGR-303', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 3 (Sistema Riego Cusco) - INGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 3, 1, 'I', 1102, 'ING-102', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 3, 2, 'I', 1103, 'ING-103', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 3 (Sistema Riego Cusco) - EGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 3, 3, 'E', 2101, 'EGR-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 3, 4, 'E', 2102, 'EGR-102', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 3, 5, 'E', 2201, 'EGR-201', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 4 (Hospital Lima) - INGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 4, 1, 'I', 1101, 'ING-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 4, 2, 'I', 1202, 'ING-202', 'N', 3, '012', 'UND', '001', 1);

-- Proyecto 4 (Hospital Lima) - EGRESOS Nivel 3
INSERT INTO PROY_PARTIDA VALUES (1, 4, 3, 'E', 2101, 'EGR-101', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 4, 4, 'E', 2103, 'EGR-103', 'N', 3, '012', 'UND', '001', 1);
INSERT INTO PROY_PARTIDA VALUES (1, 4, 5, 'E', 2104, 'EGR-104', 'N', 3, '012', 'UND', '001', 1);

COMMIT;

-- ==================================================================
-- 21. INSERTAR PROY_PARTIDA_MEZCLA - PRESUPUESTO DE PARTIDAS POR PROYECTO
-- ==================================================================
-- Columnas: CodCia, CodPyto, IngEgr, Corr, CodPartida, Sec, PadCodPartida, TUniMed, EUniMed, Nivel, Orden, CostoUnit, Cantidad, CostoTotal
-- NOTA: El Corr debe coincidir con el Corr de PROY_PARTIDA para la misma CodPartida

-- Proyecto 1 (Puente Lima-Callao) - INGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'I', 1, 1101, 1, 1100, '012', 'UND', 3, 1, 100000.00, 50, 5000000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'I', 2, 1102, 2, 1100, '012', 'UND', 3, 2, 50000.00, 30, 1500000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'I', 3, 1201, 3, 1200, '012', 'UND', 3, 3, 200000.00, 10, 2000000.00);

-- Proyecto 1 (Puente Lima-Callao) - EGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'E', 4, 2101, 1, 2100, '012', 'UND', 3, 1, 80000.00, 40, 3200000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'E', 5, 2102, 2, 2100, '012', 'UND', 3, 2, 5000.00, 200, 1000000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'E', 6, 2103, 3, 2100, '012', 'UND', 3, 3, 25000.00, 20, 500000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'E', 7, 2104, 4, 2100, '012', 'UND', 3, 4, 15000.00, 15, 225000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 1, 'E', 8, 2301, 5, 2300, '012', 'UND', 3, 5, 30000.00, 10, 300000.00);

-- Proyecto 2 (Carretera Panamericana) - INGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 2, 'I', 1, 1101, 1, 1100, '012', 'UND', 3, 1, 150000.00, 60, 9000000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 2, 'I', 2, 1201, 2, 1200, '012', 'UND', 3, 2, 300000.00, 15, 4500000.00);

-- Proyecto 2 (Carretera Panamericana) - EGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 2, 'E', 3, 2101, 1, 2100, '012', 'UND', 3, 1, 100000.00, 50, 5000000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 2, 'E', 4, 2102, 2, 2100, '012', 'UND', 3, 2, 4000.00, 300, 1200000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 2, 'E', 5, 2302, 3, 2300, '012', 'UND', 3, 3, 40000.00, 12, 480000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 2, 'E', 6, 2303, 4, 2300, '012', 'UND', 3, 4, 35000.00, 15, 525000.00);

-- Proyecto 3 (Sistema Riego Cusco) - INGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 3, 'I', 1, 1102, 1, 1100, '012', 'UND', 3, 1, 45000.00, 25, 1125000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 3, 'I', 2, 1103, 2, 1100, '012', 'UND', 3, 2, 30000.00, 20, 600000.00);

-- Proyecto 3 (Sistema Riego Cusco) - EGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 3, 'E', 3, 2101, 1, 2100, '012', 'UND', 3, 1, 60000.00, 30, 1800000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 3, 'E', 4, 2102, 2, 2100, '012', 'UND', 3, 2, 3500.00, 150, 525000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 3, 'E', 5, 2201, 3, 2200, '012', 'UND', 3, 3, 8000.00, 24, 192000.00);

-- Proyecto 4 (Hospital Lima) - INGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 4, 'I', 1, 1101, 1, 1100, '012', 'UND', 3, 1, 200000.00, 40, 8000000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 4, 'I', 2, 1202, 2, 1200, '012', 'UND', 3, 2, 180000.00, 20, 3600000.00);

-- Proyecto 4 (Hospital Lima) - EGRESOS
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 4, 'E', 3, 2101, 1, 2100, '012', 'UND', 3, 1, 120000.00, 35, 4200000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 4, 'E', 4, 2103, 2, 2100, '012', 'UND', 3, 2, 50000.00, 15, 750000.00);
INSERT INTO PROY_PARTIDA_MEZCLA VALUES (1, 4, 'E', 5, 2104, 3, 2100, '012', 'UND', 3, 3, 20000.00, 20, 400000.00);

COMMIT;

-- ==================================================================
-- 22. INSERTAR COMP_PAGODET - DETALLE DE COMPROBANTES DE PAGO A PROVEEDORES
-- ==================================================================
-- Columnas: CodCia, CodProveedor, NroCP, Sec, IngEgr, CodPartida, ImpNetoMN, ImpIgvMN, ImpTotalMN, Semilla

-- Detalle Comprobante CP-001-2023-001 (Cemento Lima - Proyecto 1)
INSERT INTO COMP_PAGODET VALUES (1, 16, 'CP-001-2023-001', 1, 'E', 2101, 50000.00, 9000.00, 59000.00, 1);

-- Detalle Comprobante CP-002-2023-002 (Cemento Lima - Proyecto 1)
INSERT INTO COMP_PAGODET VALUES (1, 16, 'CP-002-2023-002', 1, 'E', 2101, 80000.00, 14400.00, 94400.00, 1);

-- Detalle Comprobante CP-003-2023-001 (Aceros - Proyecto 1)
INSERT INTO COMP_PAGODET VALUES (1, 16, 'CP-003-2023-001', 1, 'E', 2101, 300000.00, 54000.00, 354000.00, 1);

-- Detalle Comprobante CP-004-2023-002 (Aceros - Proyecto 1)
INSERT INTO COMP_PAGODET VALUES (1, 16, 'CP-004-2023-002', 1, 'E', 2101, 200000.00, 36000.00, 236000.00, 1);
INSERT INTO COMP_PAGODET VALUES (1, 16, 'CP-004-2023-002', 2, 'E', 2102, 250000.00, 45000.00, 295000.00, 1);

-- Detalle Comprobante CP-005-2023-001 (Hidrodinámicos - Proyecto 2)
INSERT INTO COMP_PAGODET VALUES (1, 17, 'CP-005-2023-001', 1, 'E', 2101, 100000.00, 18000.00, 118000.00, 1);

-- Detalle Comprobante CP-006-2023-002 (Hidrodinámicos - Proyecto 2)
INSERT INTO COMP_PAGODET VALUES (1, 17, 'CP-006-2023-002', 1, 'E', 2103, 75000.00, 13500.00, 88500.00, 1);

-- Detalle Comprobante CP-007-2023-001 (Equipos Pesados - Proyecto 1)
INSERT INTO COMP_PAGODET VALUES (1, 18, 'CP-007-2023-001', 1, 'E', 2103, 240000.00, 43200.00, 283200.00, 1);

-- Detalle Comprobante CP-008-2023-001 (Servicios Especializados - Proyecto 2)
INSERT INTO COMP_PAGODET VALUES (1, 19, 'CP-008-2023-001', 1, 'E', 2303, 150000.00, 27000.00, 177000.00, 1);

-- Detalle Comprobante CP-009-2023-003 (Cemento - Proyecto 1)
INSERT INTO COMP_PAGODET VALUES (1, 20, 'CP-009-2023-003', 1, 'E', 2101, 40000.00, 7200.00, 47200.00, 1);

COMMIT;

-- ==================================================================
-- 23. INSERTAR COMP_PAGOEMPLEADO_DET - DETALLE DE COMPROBANTES DE PAGO A EMPLEADOS
-- ==================================================================
-- Columnas: CodCia, CodEmpleado, NroCP, Sec, IngEgr, CodPartida, ImpNetoMN, ImpIgvMN, ImpTotalMN, Semilla

-- Detalle Comprobante CPE-001-2023-001 (Empleado 1 - Febrero 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 1, 'CPE-001-2023-001', 1, 'E', 2104, 15000.00, 2700.00, 17700.00, 1);

-- Detalle Comprobante CPE-002-2023-002 (Empleado 1 - Marzo 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 1, 'CPE-002-2023-002', 1, 'E', 2104, 15000.00, 2700.00, 17700.00, 1);

-- Detalle Comprobante CPE-003-2023-001 (Empleado 2 - Febrero 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 2, 'CPE-003-2023-001', 1, 'E', 2104, 12000.00, 2160.00, 14160.00, 1);

-- Detalle Comprobante CPE-005-2023-001 (Empleado 3 - Febrero 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 3, 'CPE-005-2023-001', 1, 'E', 2104, 11000.00, 1980.00, 12980.00, 1);

-- Detalle Comprobante CPE-006-2023-002 (Empleado 3 - Marzo 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 3, 'CPE-006-2023-002', 1, 'E', 2104, 11000.00, 1980.00, 12980.00, 1);

-- Detalle Comprobante CPE-007-2023-001 (Empleado 4 - Febrero 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 4, 'CPE-007-2023-001', 1, 'E', 2104, 13000.00, 2340.00, 15340.00, 1);

-- Detalle Comprobante CPE-008-2023-002 (Empleado 4 - Marzo 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 4, 'CPE-008-2023-002', 1, 'E', 2104, 10000.00, 1800.00, 11800.00, 1);

-- Detalle Comprobante CPE-009-2023-001 (Empleado 5 - Marzo 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 5, 'CPE-009-2023-001', 1, 'E', 2104, 9000.00, 1620.00, 10620.00, 1);

-- Detalle Comprobante CPE-010-2023-002 (Empleado 5 - Abril 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 5, 'CPE-010-2023-002', 1, 'E', 2104, 9000.00, 1620.00, 10620.00, 1);

-- Detalle Comprobante CPE-011-2023-001 (Empleado 6 - Abril 2023)
INSERT INTO COMP_PAGOEMPLEADO_DET VALUES (1, 6, 'CPE-011-2023-001', 1, 'E', 2104, 18000.00, 3240.00, 21240.00, 1);

COMMIT;

-- ==================================================================
-- 24. INSERTAR VTACOMP_PAGOCAB - COMPROBANTES DE VENTA/INGRESOS
-- ==================================================================
-- Columnas: CodCia, NroCP, CodPyto, CodCliente, NroPago, TCompPago, ECompPago,
--           FecCP, TMoneda, EMoneda, TipCambio, ImpMO, ImpNetoMN, ImpIgvMN, ImpTotalMN,
--           FotoCP, FotoAbono, FecAbono, DesAbono, Semilla, TabEstado, CodEstado

-- Comprobantes de Venta para Cliente 12 - Proyecto 1 (Puente Lima-Callao)
INSERT INTO VTACOMP_PAGOCAB (
  ...
  1, 'VTA-001-2023', 1, 12,
  1, '003', '001',
  TO_DATE('15/02/23','DD/MM/RR'), '003', '001', 1,
  500000, 500000, 90000, 590000,
  NULL, NULL, TO_DATE('20/02/23','DD/MM/RR'), 'PAGO INICIAL PUENTE',
  1, '001', '001'
);
...
INSERT INTO VTACOMP_PAGOCAB (
  ...
  1, 'VTA-002-2023', 1, 12,
  2, '003', '001',
  TO_DATE('15/03/23','DD/MM/RR'), '003', '001', 1,
  750000, 750000, 135000, 885000,
  NULL, NULL, TO_DATE('20/03/23','DD/MM/RR'), 'SEGUNDO PAGO PUENTE',
  1, '001', '001'
);

-- Comprobantes de Venta para Cliente 13 - Proyecto 2 (Carretera)
INSERT INTO VTACOMP_PAGOCAB (
  CODCIA, NROCP, CODPYTO, CODCLIENTE,
  NROPAGO, TCOMPPAGO, ECOMPPAGO,
  FECCP, TMONEDA, EMONEDA, TIPCAMBIO,
  ...
  1, 'VTA-003-2023', 2, 13,
  1, '003', '001',
  TO_DATE('01/03/23','DD/MM/RR'), '003', '001', 1,
  1000000, 1000000, 180000, 1180000,
  NULL, NULL, TO_DATE('05/03/23','DD/MM/RR'), 'ANTICIPO CARRETERA',
  1, '001', '001'
);
...
INSERT INTO VTACOMP_PAGOCAB (
  ...
  1, 'VTA-004-2023', 2, 13,
  2, '003', '001',
  TO_DATE('01/04/23','DD/MM/RR'), '003', '001', 1,
  1500000, 1500000, 270000, 1770000,
  NULL, NULL, TO_DATE('05/04/23','DD/MM/RR'), 'SEGUNDO PAGO CARRETERA',
  1, '001', '001'
);

-- Comprobantes de Venta para Cliente 14 - Proyecto 3 (Sistema Riego)
INSERT INTO VTACOMP_PAGOCAB (
  CODCIA, NROCP, CODPYTO, CODCLIENTE,
  NROPAGO, TCOMPPAGO, ECOMPPAGO,
  FECCP, TMONEDA, EMONEDA, TIPCAMBIO,
  ...
  1, 'VTA-005-2023', 3, 14,
  1, '003', '001',
  TO_DATE('20/03/23','DD/MM/RR'), '003', '001', 1,
  300000, 300000, 54000, 354000,
  NULL, NULL, TO_DATE('25/03/23','DD/MM/RR'), 'PAGO SISTEMA RIEGO',
  1, '001', '001'
);

-- Comprobantes de Venta para Cliente 15 - Proyecto 4 (Hospital)
INSERT INTO VTACOMP_PAGOCAB (
  CODCIA, NROCP, CODPYTO, CODCLIENTE,
  NROPAGO, TCOMPPAGO, ECOMPPAGO,
  FECCP, TMONEDA, EMONEDA, TIPCAMBIO,
  ...
  1, 'VTA-006-2024', 4, 15,
  1, '003', '001',
  TO_DATE('10/01/24','DD/MM/RR'), '003', '001', 1,
  2000000, 2000000, 360000, 2360000,
  NULL, NULL, TO_DATE('15/01/24','DD/MM/RR'), 'ANTICIPO HOSPITAL LIMA',
  1, '001', '001'
);
...
-- ==================================================================
-- 25. INSERTAR VTACOMP_PAGODET - DETALLE DE COMPROBANTES DE VENTA/INGRESOS
-- ==================================================================
-- Columnas: CodCia, NroCP, Sec, IngEgr, CodPartida, ImpNetoMN, ImpIgvMN, ImpTotalMN, Semilla

-- Detalle VTA-001-2023 (Cliente 12 - Proyecto 1)
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-001-2023', 1, 'I', 1101, 400000.00, 72000.00, 472000.00, 1);
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-001-2023', 2, 'I', 1102, 100000.00, 18000.00, 118000.00, 1);

-- Detalle VTA-002-2023 (Cliente 12 - Proyecto 1)
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-002-2023', 1, 'I', 1101, 600000.00, 108000.00, 708000.00, 1);
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-002-2023', 2, 'I', 1102, 150000.00, 27000.00, 177000.00, 1);

-- Detalle VTA-003-2023 (Cliente 13 - Proyecto 2)
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-003-2023', 1, 'I', 1101, 800000.00, 144000.00, 944000.00, 1);
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-003-2023', 2, 'I', 1201, 200000.00, 36000.00, 236000.00, 1);

-- Detalle VTA-004-2023 (Cliente 13 - Proyecto 2)
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-004-2023', 1, 'I', 1101, 1200000.00, 216000.00, 1416000.00, 1);
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-004-2023', 2, 'I', 1201, 300000.00, 54000.00, 354000.00, 1);

-- Detalle VTA-005-2023 (Cliente 14 - Proyecto 3)
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-005-2023', 1, 'I', 1102, 200000.00, 36000.00, 236000.00, 1);
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-005-2023', 2, 'I', 1103, 100000.00, 18000.00, 118000.00, 1);

-- Detalle VTA-006-2024 (Cliente 15 - Proyecto 4)
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-006-2024', 1, 'I', 1101, 1500000.00, 270000.00, 1770000.00, 1);
INSERT INTO VTACOMP_PAGODET VALUES (1, 'VTA-006-2024', 2, 'I', 1202, 500000.00, 90000.00, 590000.00, 1);

COMMIT;

-- ==================================================================
-- 26. RESUMEN Y VALIDACIÓN DE DATOS INSERTADOS
-- ==================================================================
...
SELECT COUNT(*) AS TOTAL_PROY_PARTIDA FROM PROY_PARTIDA;
SELECT COUNT(*) AS TOTAL_PROY_PARTIDA_MEZCLA FROM PROY_PARTIDA_MEZCLA;
SELECT COUNT(*) AS TOTAL_COMP_PAGODET FROM COMP_PAGODET;
SELECT COUNT(*) AS TOTAL_COMP_PAGOEMPLEADO_DET FROM COMP_PAGOEMPLEADO_DET;
SELECT COUNT(*) AS TOTAL_VTACOMP_PAGOCAB FROM VTACOMP_PAGOCAB;
SELECT COUNT(*) AS TOTAL_VTACOMP_PAGODET FROM VTACOMP_PAGODET;
