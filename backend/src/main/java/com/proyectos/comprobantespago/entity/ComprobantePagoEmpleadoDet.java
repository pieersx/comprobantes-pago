...
/**
 * Entidad COMP_PAGOEMPLEADO_DET - Detalle de Comprobantes de Pago a Empleados
 */
@Entity
@Table(name = "COMP_PAGOEMPLEADO_DET")
@IdClass(ComprobantePagoEmpleadoDet.ComprobantePagoEmpleadoDetId.class)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ComprobantePagoEmpleadoDet implements Serializable {
    ...
    private ComprobantePagoEmpleado comprobanteCabecera;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class ComprobantePagoEmpleadoDetId implements Serializable {
        private Long codCia;
        private Long codEmpleado;
        private String nroCp;
        private Integer sec;
